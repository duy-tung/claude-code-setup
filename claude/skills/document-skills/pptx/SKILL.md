...
**Note**: The unpack.py script is located at `skills/document-skills/pptx/ooxml/scripts/unpack.py` relative to the skills root. If the script doesn't exist at this path, use `find . -name "unpack.py"` to locate it.
