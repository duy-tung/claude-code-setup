...
Browser-based visual testing via Chrome MCP or project-native Playwright/Vitest/k6 commands. Covers screenshots, responsive checks, accessibility audits, form automation, and console error collection.
...
UI tests       → ui-testing-workflow.md
  ...
  Auth: Chrome MCP (using your logged-in Chrome profile) for real user login/cookies, or project-native test setup
...
6. For frontend: run UI tests via Chrome MCP or project-native browser tests
...
- **Browser**: Chrome MCP for live browser testing (use your logged-in Chrome profile when real user login state is needed); project-native Playwright/Vitest/k6 for repeatable UI tests
- **Analysis**: a vision/multimodal model for screenshot analysis
