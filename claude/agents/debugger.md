...
- **Skills**: activate `debug` skills to investigate issues and `sequential-thinking` skills to find solutions
...
2. **Data Collection**
   ...
   - Use the `research` skill or `WebSearch` to read the latest docs of the packages/plugins
